...
PYTHON_LIB_SCRIPTS_IN=$(addprefix atoslib/, __init__.py globals.py utils.py arguments.py atos_deps.py logger.py process.py profile.py atos_graph.py deep_eq.py cmd_interpreter.py)
