...
CONFIG_SCRIPTS_EXE_IN=atos-audit.in atos-raudit.in atos-deps.in atos-build.in atos-run.in atos-profile.in atos-explore.in atos-play.in atos-graph.in atos-explore-inline.in atos-explore-loop.in atos-opt.in atos-init.in atos-replay.in atos-config.in
CONFIG_SCRIPTS_LIB_IN=atos_toolkit.py.in atos_lib.py.in
CONFIG_SCRIPTS_CFG_IN=flags.inline.cfg.in flags.loop.cfg.in
