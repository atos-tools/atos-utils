...
CONFIG_SCRIPTS_EXE_IN=atos-audit.in atos-raudit.in atos-build.in atos-run.in atos-explore.in atos-play.in atos-graph.in atos-explore-inline.in atos-explore-loop.in atos-explore-optim.in atos-opt.in atos-init.in atos-replay.in atos-config.in atos-explore-acf.in atos-explore-staged.in
...
PYTHON_SCRIPTS_IN=atos.py atos-help.py atos-deps.py atos-profile.py
