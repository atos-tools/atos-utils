...
PYTHON_LIB_SCRIPTS_IN=$(addprefix atoslib/, __init__.py globals.py utils.py arguments.py atos_deps.py logger.py process.py profile.py atos_graph.py deep_eq.py cmd_interpreter.py atos_argparse.py regexp.py gen_argparse.py cc_arguments.py cc_argparse.py obj_storage.py graphs.py recipes.py)
...
SHARED_RSTS_IN=$(addprefix doc/, intro.rst tutorial.rst benchmarks.rst example-sha1.rst example-coremark.rst)
