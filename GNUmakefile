...
CONFIG_SCRIPTS_EXE_IN=atos-graph.in atos-explore-inline.in atos-explore-loop.in atos-explore-optim.in atos-config.in atos-explore-acf.in atos-explore-staged.in
...
PYTHON_SCRIPTS_IN=atos.py atos-help.py atos-audit.py atos-build.py atos-deps.py atos-explore.py atos-init.py atos-opt.py atos-play.py atos-profile.py atos-raudit.py atos-run.py atos-driver.py atos-timeout.py atos-replay.py
