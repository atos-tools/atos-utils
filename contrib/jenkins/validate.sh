...
# - the script is working for local build from gnxXXXX.gnb.st.com machines.
#
...
wget -q -O proot-devimage.tgz http://aci-cec.gnb.st.com:8000/job/cec-okla-proot-dev-guillon/lastStableBuild/artifact/proot-devimage.tgz
tar xvzf proot-devimage.tgz -C $DEVIMAGE

echo "Retrieving binary build of python-jsonlib package..."
wget -q -O python-jsonlib.tgz http://aci-cec.gnb.st.com:8000/job/cec-okla-python-jsonlib/lastStableBuild/artifact/python-jsonlib.tgz
...
wget -q -O python-requests.tgz http://aci-cec.gnb.st.com:8000/job/cec-okla-python-requests/lastStableBuild/artifact/python-requests.tgz
...
wget -q -O python-coverage.tgz http://aci-cec.gnb.st.com:8000/job/cec-okla-python-coverage/lastStableBuild/artifact/python-coverage.tgz
...
git clone gitolite@codex.cro.st.com:atos/gcc-prebuilt-ubuntu-10.04-x86-64-gcc-4.7.2.git prebuilt/gcc-4.7.2
