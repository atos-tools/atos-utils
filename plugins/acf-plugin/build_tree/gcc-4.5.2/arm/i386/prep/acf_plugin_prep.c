...
extern long long frame_larger_than_size;
...
extern unsigned long long g_switch_value;
...
void cgraph_add_thunk (tree, tree, unsigned char, long long, long long, tree, tree);
