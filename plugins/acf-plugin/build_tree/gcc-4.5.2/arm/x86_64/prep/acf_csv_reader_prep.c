...
# 1308 "/opt/gcc-plugins/prebuilt/x86_64/gcc-4.5.2/bin/../lib/gcc/x86_64-unknown-linux-gnu/4.5.2/include-fixed/bits/string2.h" 3 4
...
# 1309 "/opt/gcc-plugins/prebuilt/x86_64/gcc-4.5.2/bin/../lib/gcc/x86_64-unknown-linux-gnu/4.5.2/include-fixed/bits/string2.h" 2 3 4




extern char *__strdup (__const char *__string) __attribute__ ((__nothrow__)) __attribute__ ((__malloc__));
# 1332 "/opt/gcc-plugins/prebuilt/x86_64/gcc-4.5.2/bin/../lib/gcc/x86_64-unknown-linux-gnu/4.5.2/include-fixed/bits/string2.h" 3 4
...
void acf_ftable_display(acf_ftable_entry_t *acf_ftable) {
  ...
  for (table_r = 0; table_r < acf_ftable_size; table_r++) {
      ...
      fprintf(stderr, "%s,", (acf_ftable[table_r].opt_file != ((void *)0) ? acf_ftable[table_r].opt_file : "(null)"))
                                                 ;
   ...
   case NO_TYPE:
       break;
   case STR_TYPE:
       fprintf(stderr, "\'%s\',", (acf_ftable[table_r].opt_args[i].av.str_arg != ((void *)0) ? acf_ftable[table_r].opt_args[i].av.str_arg : "(null),"))
                                                                ;
       break;
   case INT_TYPE:
 ...
 *acf_ftable_p = (acf_ftable_entry_t *) malloc(tsize);
 if (*acf_ftable_p == ((void *)0)) {
    ...
    for(; crow != ((void *)0); crow = crow->next_row, cur_line++) {
 int j;
