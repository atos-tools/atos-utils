...
# 27 "/opt/gcc-plugins/src/acf_plugin.h"
...
# 46 "/opt/gcc-plugins/src/acf_plugin.h"
...
# 225 "/opt/gcc-plugins/src/acf_plugin.c"
 set_option(&cl_options[opt_index], opt_value, ((void *)0));
...
# 505 "/opt/gcc-plugins/src/acf_plugin.c"
...
int plugin_init(struct plugin_name_args *plugin_na,
  struct plugin_gcc_version *version){
    ...
    unsigned char bad = 0;
    int i;
# 630 "/opt/gcc-plugins/src/acf_plugin.c"
...
# 644 "/opt/gcc-plugins/src/acf_plugin.c"
...
# 780 "/opt/gcc-plugins/src/acf_plugin.c"
    return 0;
}
