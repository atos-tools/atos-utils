...
[ "`$ROOT/lib/atos/atos_lib.py config --get default_values.remote_profile_path`" = "/work1/tmp1" ]

$ROOT/bin/atos-init -B /work1/tmp2

[ "`$ROOT/lib/atos/atos_lib.py config --get default_values.remote_profile_path`" = "/work1/tmp2" ]
