...
#
#   gen_flags_file
#     gen_flags_file(flags_file='', base_flags='')
#
...
try:
    gen = generators.gen_flags_file('XXXX')
    cfg = generated_configs(gen)
except AssertionError: pass
else: assert 0
...
gen = generators.gen_flags_file('flags1.txt')
cfg = generated_configs(gen)
assert len(cfg) == 3
...
gen = generators.gen_flags_file('flags1.txt', base_flags='9 9')
cfg = generated_configs(gen)
assert len(cfg) == 3
...
#     gen_rnd_uniform_deps(flags_file='', optim_levels='', base_flags='')
#
...
gen = generators.gen_rnd_uniform_deps(
    flags_file='flags2.txt', base_flags='-O0')
cfg = generated_configs(gen, max_iter=5)
assert len(cfg) == 5
assert len(query_configs(cfg, flags='-O0')) == 5

gen = generators.gen_rnd_uniform_deps(
    flags_file='flags2.txt', base_flags='-O1')
...
gen = generators.gen_rnd_uniform_deps(
    flags_file='flags2.txt', base_flags='-O2')
cfg = generated_configs(gen, max_iter=1000)
assert len(cfg) == 1000
...
gen = generators.gen_rnd_uniform_deps(
    flags_file='flags2.txt', optim_levels='-O0')
cfg = generated_configs(gen, max_iter=1000)
assert len(cfg) == 1000
...
gen = generators.gen_rnd_uniform_deps(
    flags_file='flags2.txt', optim_levels='-O1,-O2,-O3')
cfg = generated_configs(gen, max_iter=1000)
assert len(cfg) == 1000
...
gen = generators.gen_rnd_uniform_deps(
    flags_file='flags2.txt', optim_levels='-O2')
cfg = generated_configs(gen, max_iter=1000)
assert len(cfg) == 1000
