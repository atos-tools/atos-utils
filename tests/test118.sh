...
TEST_CASE="ATOS flags_pruning - acf function-by-function"
...
$ROOT/bin/atos-explore-acf \
    --optim-variants=base --optim-levels=-O0 \
    --hot-th=50 -Y "-Os cold" -F ./flags_list.txt
